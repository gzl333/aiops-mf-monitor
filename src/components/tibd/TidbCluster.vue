...
interface UnitTidbInterface {
  ...
  connections_count: Record<string, any>[]
  // eslint-disable-next-line
  current_storage_size: Record<string, any>[]
  // eslint-disable-next-line
  pd_nodes: Record<string, any>[]
  // eslint-disable-next-line
  qps: Record<string, any>[]
  // eslint-disable-next-line
  region_count: Record<string, any>[]
  // eslint-disable-next-line
  region_health: Record<string, any>[]
  // eslint-disable-next-line
  server_cpu_usage: Record<string, any>[]
  server_cpu_usage_max: string
  // eslint-disable-next-line
  server_disk_usage: Record<string, any>[]
  server_disk_usage_max: string
  // eslint-disable-next-line
  server_mem_usage: Record<string, any>[]
  server_mem_usage_max: string
  // eslint-disable-next-line
  storage: Record<string, any>[]
  // eslint-disable-next-line
  storage_capacity: Record<string, any>[]
  // eslint-disable-next-line
  tidb_nodes: Record<string, any>[]
  // eslint-disable-next-line
  tikv_nodes: Record<string, any>[]
  totalConnect: number
  totalQbs: number
}
